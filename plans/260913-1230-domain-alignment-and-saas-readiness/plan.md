...
Public app origin là `https://design.7app.online`; backend AI được cấu hình là `https://pro.autommo.online/v1`. Plan tách rõ remediation không làm thay đổi dữ liệu khỏi các gate cần Đại Ka duyệt trước (OAuth thật, AI generation, credit/admin/payment mutation).
...
- [ ] `pro.autommo.online` chỉ xuất hiện như AI provider; không bị đổi theo public-origin migration.
