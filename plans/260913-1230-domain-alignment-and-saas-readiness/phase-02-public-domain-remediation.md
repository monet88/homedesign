...
Make `design.7app.online` the sole public application origin everywhere that is current/operational, while preserving `pro.autommo.online` as the AI provider endpoint.
