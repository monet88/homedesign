/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 40a6b07edbd5b489e375f5138eed44b5)
// Runtime types generated with workerd@1.20260825.1 2026-08-24 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
	HD_PRIVATE: R2Bucket;
	HD_PUBLIC: R2Bucket;
	DB: D1Database;
	ASSET_VALIDATE: Queue;
	PROVIDER_NOTIFY: Queue;
	ASSETS: Fetcher;
	ENVIRONMENT: "local";
	BETTER_AUTH_URL: "http://localhost:3000";
	BETTER_AUTH_SECRET: "dev-only-insecure-secret-for-local-e2e";
	EMAIL_DELIVERY_MODE: "test-outbox";
	WORKER_SELF_REFERENCE: Fetcher /* homedesign */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "EMAIL_DELIVERY_MODE">> {}
}
