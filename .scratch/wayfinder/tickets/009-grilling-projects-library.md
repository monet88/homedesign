...
- Activity là timeline append-only, owner-only cho Project lifecycle, upload ready/rejected, generation/stage started/succeeded/failed và Mock Purchase succeeded/failed. Không ghi polling, view/download hay từng Credit Hold; giữ 90 ngày và không thay thế audit log/Credit Ledger.
